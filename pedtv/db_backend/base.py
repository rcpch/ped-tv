"""
Custom PostgreSQL database backend that authenticates using an Azure Entra ID
...
stock PostgreSQL backend by calling ``super().get_connection_params()``, keeping
...
from django.db.backends.postgresql.base import (
    DatabaseWrapper as PostgresWrapper,
)
